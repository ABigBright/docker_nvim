...
RUN yaourt -Sy --noconfirm --disable-download-timeout global ripgrep python3 git npm the_silver_searcher yarn clang ctags python-pip ranger ueberzug gcc w3m ffmpegthumbnailer imlib2
